...
<div class="actuatorSetterView">
            <b>Un actionneur:</b>
            <select @click="selectGauche()" id="selectGauche" v-model="selectedActuatorG" class="custom-select"
            style="width:auto;">
              <option
...
methods: {
selectGauche(){
    console.log(this.selectedActuatorGauche);

if(this.selectedActuatorGauche === 'faceparface'){
